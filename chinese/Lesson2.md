...
今天我们要学习下学习率。先讲下这个。在学习率查找器的图形里，需要找的是这个最长的向下的斜坡。想找到有效的部分，需要多练习来找到些感觉。如果你不确定，就多试几个，看看哪个运行得更好。我试了一下，觉得这部分（10^-5到10^-3之间）最好。我会选择这里的作为学习率。 [[28:28](https://youtu.be/Egp4Zajhzog?t=1708)].
